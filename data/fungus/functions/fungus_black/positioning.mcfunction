...
#unique to different fungus types
	execute as @e[type=area_effect_cloud, tag=fungus.body, limit=1] at @e[type=area_effect_cloud, tag=fungus.head] run function fungus:fungus_black/spread_1
	
#Run constructor
	execute as @e[type=area_effect_cloud, tag=fungus.placer] at @s run function fungus:fungus_black/constructor